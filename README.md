...
~~~sh
# getting the code
git clone git@github.com:nko4/touchday.git && cd ./touchday/

# developing
npm install
npm start

# deploying (to http://touchday.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@touchday.2013.nodeknockout.com
ssh root@touchday.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@touchday.2013.nodeknockout.com
ssh -i ./id_deploy root@touchday.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/touchday" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
